...
import type { CourseSummary, MetricValue, ProfessorSummary, StudentComment } from "@/data/types";
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--muted)]">{formatDate(comment.createdAt)}</p>
          </div>
        </div>
