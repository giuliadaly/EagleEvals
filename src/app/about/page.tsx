...
export default async function AboutPage() {
  ...
  return (
    <InfoPage eyebrow="About" title="EagleEvals for BC students" intro="EagleEvals helps Boston College students choose classes with course information, professor details, structured ratings, and written reviews from BC students past and present.">
      ...
      <h2 id="ratings" className="scroll-mt-32">How to read the ratings</h2>
      <p>Historical records contain section-level evaluation summaries. New submissions add individual 1–5 ratings and a written comment. Scores average the available numerical values, treating each record equally; the counts refer to records, not the number of students represented.</p>
      <p>Written comments are counted separately. A course or professor can have numerical ratings without any written reviews. The “No written reviews yet” label means written feedback is missing, even when a numerical score is available.</p>
