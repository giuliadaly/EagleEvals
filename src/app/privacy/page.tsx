...
export default function PrivacyPage() {
  return (
    <InfoPage eyebrow="Policy" title="Privacy" intro="EagleEvals makes course and professor evaluations publicly readable and accepts new reviews without user accounts or identity fields.">
      ...
      {process.env.NEXT_PUBLIC_ENABLE_PRODUCT_EVENTS === "true" ? <p>We also measure search result availability, opening a search suggestion, sending a search, starting a review, successful submissions, broad error categories, and completion-time ranges. These events do not include search terms, review text, rating answers, selected course or professor IDs, review IDs, names, or email addresses.</p> : <p>Additional search and review interaction tracking is currently paused.</p>}
      <p>Query parameters and fragments are removed from analytics page URLs. Ordinary public course and professor page paths remain visible in page-view reports.</p>
