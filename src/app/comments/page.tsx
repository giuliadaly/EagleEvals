      ...
      <main className="flex-1">
        <section className="border-b border-[var(--line)] bg-white py-10 sm:py-14">
          <div className="page-shell">
            ...
            <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--ink-soft)]">These are all public written comments recovered from the former EagleEval service plus new anonymous submissions. They are displayed as written and may describe older course formats.</p>
