...
- The bottom fold flies up and around the right side. Play once automatically on the first homepage load in a tab, then replay only when the logo is clicked.
